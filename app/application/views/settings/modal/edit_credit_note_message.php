	...
	<form action="<?php echo base_api_url('email_settings'); ?>" method="put">
        <div class="modal-content  modal-sm">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Send Credit Note Message</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">			
                    ...
                    <div class="col-sm-12">
                        <select class="selectpicker tokenSelector full-width" disabled="disabled">
                            ...
                            <option data-tokens="{{credit_note_number}}" class="tokenSelection">Credit Note Number</option>
                ...
                <div class="form-group">			
                    <div class="col-sm-12">
                        <label for="credit_note_message" class="control-label">Message</label>      
                    </div>            
                    <div class="col-sm-12">
                       <textarea id="credit_note_message" name="credit_note_message" rows="6" class="form-control tokenIntertArea" placeholder="Type the default message that will display in an email when your Credit Note is sent. Then insert token from above within your message. These tokens will be replaced with values and can be edited before the email is sent."><?php  echo $email_data['credit_note_message']; ?></textarea>                      
                    </div>
                </div>
        ...
        <div class="modal-buttons">
            <button data-modal-body="Credit Note message updated successfully. " data-close-delay-seconds="1" data-modal-heading="Success" data-modal-url="<?php echo base_url('modal/notice'); ?>" type="button" class="btn btn-success saveButton saveFormData padded">Save</button> or <a href="#" data-dismiss="modal">Cancel</a>
        </div>           
	</form>
</div>