	...
	<form action="<?php echo base_api_url('email_settings'); ?>" method="put">
        <div class="modal-content  modal-sm">    
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Send Statement Message</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">			
                    <div class="col-sm-12">
                        <label for="statement_message" class="control-label">Message</label>      
                    </div>            
                    <div class="col-sm-12">
                       <textarea id="statement_message" name="statement_message" rows="6" class="form-control tokenIntertArea" placeholder="Type the default message that will display in an email when your statement is sent. Then insert token from above within your message. These tokens will be replaced with values and can be edited before the email is sent."><?php  echo $email_data['statement_message']; ?></textarea>                      
                    </div>
                </div>
        ...
        <div class="modal-buttons">
           <button data-modal-body="Statement message updated successfully. " data-close-delay-seconds="1" data-modal-heading="Success" data-modal-url="<?php echo base_url('modal/notice'); ?>" type="button" class="btn btn-success saveButton saveFormData padded">Save</button> or <a href="#" data-dismiss="modal">Cancel</a>
        </div>
    </form>           
</div>