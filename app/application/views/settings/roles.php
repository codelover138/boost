...
?>
                 <div class="security-role-item">
                     <input <?php echo $checked_html; ?>
                         name="role_data['<?php echo $role_data['id']; ?>']['<?php echo $permission_data['id']; ?>']"
                         id="<?php echo $role_data['role_name'] . '_' . $permission_data['id']; ?>" type="checkbox"
                         value="yes">
                     <label for="<?php echo $role_data['role_name'] . '_' . $permission_data['id']; ?>"
                         class="control-label"><?php echo $permission_data['permission']; ?></label>
                 </div>
                 <?php
    }
?>
...
?>
         ...
         <div class="form_section container-fluid" style="text-align:right;">
             <button data-redirect-url="<?php echo base_url('settings/roles'); ?>" data-redirect-without-id="true"
                 data-modal-url="<?php echo base_url('modal/notice'); ?>" data-close-delay-seconds="1"
                 data-modal-heading="Success" data-modal-body="Saved Successfully. " type="button"
                 class="btn btn-default saveButton padded saveFormData">Save</button>
             <button data-redirect-url="<?php echo base_url('settings/items'); ?>" data-redirect-without-id="true"
                 data-modal-url="<?php echo base_url('modal/notice'); ?>" data-close-delay-seconds="1"
                 data-modal-heading="Success" data-modal-body="Saved Successfully. " type="button"
                 class="btn btn-success saveButton saveFormData">Save & Continue</button>
         </div>
     </div>
