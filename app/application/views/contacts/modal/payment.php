...
<div class="modal-dialog" role="document">
    <form action="<?php echo base_api_url('payments/'); ?>" data-validation-placement="below" <?php if(isset($form_dataset)){ echo $form_dataset;} ?> method="post">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-sm-3 form-group">
                        <label for="payment_amount" class="control-label">Payment <span class="text-light">(<?php echo $contact_data['currency_short_code']; ?>)</span></label>
                    </div>
                    <div class="col-sm-9 form-group">
                        <input class="payment_amount form-control" name="payment_amount" data-outstanding-amount="<?php echo $contact_data['amount_outstanding']; ?>" data-original-amount="0.00" id="payment_amount" value="0.00">           
                    </div>
                     <div class="col-sm-3 form-group">
                    ...
                    <?php
						if($contact_data['contact']['account']['credit']>0){
                    ?>
                            <div class="col-sm-6 form-group">
                                 <label class="checkbox-inline" style="margin-top:0;">
                                    <input name="use_credit" value="yes" type="checkbox" autocomplete="off" checked> Use account credit (<?php echo $contact_data['currency_symbol'].number_format($contact_data['contact']['account']['credit'],2,'.',','); ?>)
                                </label>          
                            </div>
                    <?php
						}
                    ...
                    <div class="col-sm-9 form-group">
                        <input name="reference" class="form-control" id="reference" value="<?php echo $contact_data['contact_number']; ?>">           
                    </div>
        ...
        <div class="modal-buttons">
            <button  data-related-section="contacts" data-related-id="<?php echo $contact_data['id']; ?>" data-modal-body="Payment added successfully. " data-close-delay-seconds="1" data-modal-heading="Success" data-modal-url="<?php echo base_url('modal/notice'); ?>" type="button" class="btn btn-success saveButton saveFormData padded">Add Payment</button> or <a href="#" data-dismiss="modal">Cancel</a>
        </div> 
    </form>        
</div>
