...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-buttons">
        <button id="saveReminder" <?php  if(isset($id)){ echo 'data-contact-id="'.$id.'"'; }else{echo 'data-contact-id="new"';} ?>  data-dismiss="modal" type="button" class="btn btn-success saveButton padded">Save</button> or <a href="#" data-dismiss="modal">Cancel</a>
    </div>           
</div>