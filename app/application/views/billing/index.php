...
<?php if ($status_key === 'grace_period') : ?>
<div class="alert alert-warning">
    ...
    You still have workspace access until
    <strong><?php echo htmlspecialchars(billing_display_datetime($grace_period_ends_at)); ?></strong>.
    Renew before then to keep access uninterrupted.
</div>
...
<div class="alert alert-warning">
    ...
    <strong><?php echo htmlspecialchars(billing_display_datetime(isset($subscription['paid_until']) ? $subscription['paid_until'] : null)); ?></strong>,
    then your grace period begins. Renew before the grace period ends to avoid deactivation.
</div>
    ...
    <div class="billing-section billing-panel billing-card">
        ...
        <div class="billing-management-grid">
            ...
            <div class="billing-management-card">
                ...
                <p class="billing-management-copy">
                    <?php if ($status_key === 'grace_period') : ?>
                    Renewal is stopped. Your paid term has ended, and grace access remains available until
                    <?php echo htmlspecialchars(billing_display_datetime($grace_period_ends_at)); ?>.
                    <?php elseif ($cancel_at_period_end) : ?>
                    Cancellation is already scheduled. Access remains available until
                    <?php echo htmlspecialchars(billing_display_datetime(isset($subscription['paid_until']) ? $subscription['paid_until'] : null)); ?>, then the grace period begins.
