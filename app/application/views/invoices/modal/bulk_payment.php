...
<div class="modal-dialog" role="document">
    <form action="<?php echo base_api_url('bulk/payments'); ?>" method="post">
        <div class="modal-content">
			...
			?>
                    <div class="modal-body">
                            ...
                            <input type="hidden" name="data[<?php echo $count; ?>]['invoice_id']" value="<?php echo $invoice_data['id']; ?>" />
                            <div class="clearfix padded-top "></div> 
                            <div class="col-sm-12 form-group">
                            <?php // var_dump($invoice_data['contact']); ?>
                            ...
                            <div class="col-sm-3 form-group">
                                <label for="data[<?php echo $count; ?>]['payment_amount']" class="control-label">Payment <span class="text-light">(<?php echo $invoice_data['currency_short_code']; ?>)</span></label>
                            </div>
                            <div class="col-sm-9 form-group">
                                <input class="payment_amount form-control" name="data[<?php echo $count; ?>]['payment_amount']" id="data[<?php echo $count; ?>]['payment_amount']" data-outstanding-amount="<?php echo $invoice_data['amount_outstanding']; ?>" data-original-amount="0.00" value="0.00">           
                            </div>
                             <div class="col-sm-3 form-group">
                            ...
                            <?php
                                if($invoice_data['contact']['account']['account_standing']>0){
                            ?>
                                    <div class="col-sm-6 form-group">
                                         <label class="checkbox-inline" style="margin-top:0;">
                                            <input name="data[<?php echo $count; ?>]['use_credit']" value="yes" type="checkbox" autocomplete="off" checked> Use account credit (<?php echo $invoice_data['currency_symbol'].number_format($invoice_data['contact']['account']['account_standing'],2,'.',','); ?>)
                                        </label>          
                                    </div>
                            <?php
                                }
                            ...
                            <div class="col-sm-9 form-group">
                                <input name="data[<?php echo $count; ?>]['reference']" class="form-control" id="data[<?php echo $count; ?>]['reference']" value="<?php echo $invoice_data['invoice_number']; ?>">           
                            </div>
        ...
        <div class="modal-buttons">
            <button data-modal-body="Payments added successfully. " data-related-section="invoices" data-related-ids="<?php echo implode(',',$invoice_ids); ?>" data-close-delay-seconds="1" data-modal-heading="Success" data-modal-url="<?php echo base_url('modal/notice'); ?>" type="button" class="btn btn-success saveButton saveFormData padded">Save</button> or <a href="#" data-dismiss="modal">Cancel</a>
        </div> 
    </form>        
</div>
