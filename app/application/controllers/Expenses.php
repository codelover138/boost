...
class Expenses extends CI_Controller
{
	...
	public function duplicate()
	{
		...
		$data['page']['title'] = 'New Expense';
		$data['page']['heading'] = 'New Expense';
		$data['page']['main_view'] = 'expenses/duplicate';
	...
	public function preview()
	{
		...
		$send_data = array(
			'piggyback' => array('currencies', 'organisations')
		);
		...
		//if you wanted to revert back to using "preview" in the url then all links to preview pages would need to have expenses/preview/id as the url
		...
		//this define page data
		$data['page']['title'] = 'Preview Expense';
		$data['page']['heading'] = 'Preview Expense';
		$data['page']['main_view'] = 'expenses/preview';
		$data['page']['header_button_view'] = 'expenses/sub_header_buttons/preview';
