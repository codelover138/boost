...
class Contacts extends CI_Controller{ 
    ...
    public function index()
    {
		...
		$order_by = ($this->uri->segment(2) ? $this->uri->segment(2) : 'organisation');
		$direction = ($this->uri->segment(3) ? $this->uri->segment(3) : 'asc');
		...
		$data['request'] = $this->curl->api_call('GET', 'contacts/'.$order_by.'/'.$direction.'/'.$results_per_page.'/'.$starting_record, $send_data);	
		...
		$data['page']['heading'] = 'Contacts';
		$data['page']['main_view'] = 'contacts/list';
		$data['page']['header_button_view'] = 'contacts/sub_header_buttons/list';
		
		//this defines what is shown in the activity bar
		//$data['activity']['heading'] = 'Contacts Activity';
		//$data['activity']['category'] = 'contacts';
    ...
    {	
		...
		$send_data['piggyback'] = array('industries','contact_types','company_sizes');
		...
		//set the initial type of contact
		$data['type'] = 'client';
		
		//this define page data
		$data['page']['title'] = 'New Contact';
		$data['page']['heading'] = 'New Contact';
		$data['page']['main_view'] = 'contacts/create';
	...
	public function statements(){
		...
		$data['request'] = $this->curl->api_call('GET', 'statements/'.$contact_id, $send_data);
		
		$organisation_data = array_values($data['request']['piggyback']['organizations'])[0];
		
		$currency_id = $organisation_data['currency_id'];		
		$data['request']['currency_symbol'] = $data['request']['piggyback']['currencies'][$currency_id]['currency_symbol'];		
		...
		$data['request']['filters']['filter_string'] = '?'.http_build_query($data['request']['filters']);
		
		//set the initial type of contact
		$data['type'] = 'client';

		//this define page data
		$data['page']['title'] = 'Statement';
		$data['page']['heading'] = 'Statement';
		$data['page']['main_view'] = 'contacts/statement';
		$data['page']['header_button_view'] = 'contacts/sub_header_buttons/statement';
    ...
    {	
		...
		//this define page data
		$data['page']['title'] = 'Edit Contact';
		$data['page']['heading'] = 'Edit Contact';
		$data['page']['main_view'] = 'contacts/edit';
		//var_dump($data['request']['data']);
		$this->load->view('content',$data);
    }
