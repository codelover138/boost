...
?>
 <!-- content area -->
   <form method="post" action="<?php echo base_api_url('estimates/'); ?>"  autocomplete="off">
      ...
      <div class="form_section">
         ...
         <?php 
          ...
          <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
            ...
            <div class="col-sm-9 pull-right-sm no-gutter-xs">
                <input type="text" class="form-control" name="estimate_number" id="estimate_number" value="EST-<?php echo $request['piggyback']['estimates/next_reference']; ?>">
            </div>
          </div> 
		  ...
		  ?>
           <div class="form-group col-xs-12 col-sm-6 pull-left-sm clear-left-sm">
             <div class="col-sm-9  pull-right-sm no-gutter-xs">
                ...
                <a id="reminder_cta" href="<?php echo base_url('estimates/modal/reminder/'); ?><?php echo $estimate_data['reminder']; ?>/<?php echo $estimate_data['id']; ?>" class="open-modal">
                	<?php
