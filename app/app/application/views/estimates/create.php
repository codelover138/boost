...
$base_currency_data = reset($request['data']);
     ...
     <div class="form_section">
         <div class="form-group col-xs-12 col-sm-6   pull-left-sm clear-left-sm">
              <div class="form-group col-xs-12  no-gutter-xs">
               ...
               <textarea name="terms" rows="6" class="form-control" placeholder="Terms (or Banking Details)"><?php echo $template_data['estimate_terms']; ?></textarea>                        
              </div>
         </div>
         <div class="form-group col-xs-12 col-sm-6 pull-right-sm clear-right-sm">
               <div class="form-group col-xs-12 no-gutter-xs">
               <label for="closing_note" class="control-label">Closing Note:</label>                       
               <textarea name="closing_note" rows="6" class="form-control" placeholder="Add notes visible to client"><?php echo $template_data['estimate_closing_note']; ?></textarea>                        
              </div>
         </div>
     </div>
