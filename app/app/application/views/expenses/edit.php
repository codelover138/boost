...
$datetime = strtotime($document_data['date']);
...
?>
 ...
 <!-- content area -->
    <form method="put" action="<?php echo base_api_url('expenses/'.$document_data['id']); ?>"  autocomplete="off">
    ...
    <div class="container-fluid bg-white doc-spaced">
      ...
      <div class="form_section">
          <div class="form-group col-xs-12 col-sm-6">
            ...
            <div class="col-sm-9 pull-right-sm no-gutter-xs">            
				<?php 
					...
					$contact_data['current_id'] = @$document_data['supplier_id'];
          ...
          <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
            ...
            <div class="col-sm-9  pull-right-sm no-gutter-xs">
                <input type="text" class="form-control datepicker" name="date" id="date" value="<?php echo $date; ?>">
            </div>
          </div>  
          ...
          <div class="form-group col-xs-12 col-sm-6 pull-left-sm clear-left-sm">
            ...
            <div class="col-sm-9  pull-right-sm no-gutter-xs">
               <input name="total_amount" class="form-control" id="total_amount" placeholder="0.00" value="<?php echo $document_data['total_amount']; ?>">
            </div>
          </div>
          ...
          <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
            ...
            <div class="col-sm-9  pull-right-sm  no-gutter-xs">
                <select id="tax_1" name="tax_1" class="selectpicker full-width"> 
                     <option disabled="disabled" value="0" <?php if(!isset($document_data['tax_1'])){echo ' selected="selected"';} ?>>Choose Tax</option>
                     ...
                     <?php
                        foreach($request['piggyback']['taxes'] as $tax_data){
							if($document_data['tax_1'] == $tax_data['id']){
                            	echo '<option value="'.$tax_data['id'].'" selected="selected">'.$tax_data['tax_name'].'</option>';
							}else{
          ...
          <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
            ...
            <div class="col-sm-9  pull-right-sm  no-gutter-xs">
                <select id="tax_2" name="tax_2" class="selectpicker full-width"> 
                     ...
                     <?php
                        foreach($request['piggyback']['taxes'] as $tax_data){
							if($document_data['tax_2'] == $tax_data['id']){
                            	echo '<option value="'.$tax_data['id'].'" selected="selected">'.$tax_data['tax_name'].'</option>';
							}else{
								echo '<option value="'.$tax_data['id'].'">'.$tax_data['tax_name'].'</option>';
							}
     ...
     <div class="form_section">
          <div class="form-group col-xs-12 col-sm-6">
            ...
            <div class="col-sm-9 pull-right-sm no-gutter-xs">            
				<?php 
					...
					$contact_data['current_id'] = @$document_data['contact_id'];
                    $this->load->view('global_snippets/select_contact',$contact_data);  
                ?>
            </div>
          </div>
          ...
          <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
            ...
            <div class="col-sm-9  pull-right-sm no-gutter-xs">
                <input type="text" name="notes" id="notes" class="form-control" value="<?php echo $document_data['notes']; ?>">
            </div>
          </div>  
               ...
               <select id="category_id" name="category_id" class="selectpicker full-width"> 
                   ...
                   <?php
                       foreach($request['piggyback']['expenses_categories'] as $category_data){
						   if($document_data['category_id'] == $category_data['id']){
                           	echo '<option value="'.$category_data['id'].'" selected="selected">'.$category_data['category_name'].'</option>';
						   }else{
    ...
    <div class="form_section container-fluid" style="text-align:right;">
         ...
         <button data-modal-url="<?php echo base_url('modal/notice'); ?>" data-close-delay-seconds="1" data-modal-heading="Success" data-modal-body="Saved Successfully. " type="button" class="btn btn-success saveButton saveFormData">Save</button>
    </div>
