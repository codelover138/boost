...
<div class="modal-dialog" role="document">
    <form action="<?php echo base_api_url('bulk/credit_notes/status/sent'); ?>" method="put">
        <div class="modal-content">
            ...
            <div class="modal-body">
            	<div class="col-sm-12 form-group">
                	<strong>Are you sure you want to save the following credit Notes as sent?</strong>
                </div>
        ...
        <div class="modal-buttons">
            <button data-close-delay-seconds="1" data-modal-heading="Success" data-modal-body="Items were successfully marked as sent. " data-related-section="credit_notes" data-related-ids="<?php echo implode(',',$credit_note_ids); ?>" data-modal-url="<?php echo base_url('modal/notice'); ?>" type="button" class="btn btn-success saveButton saveFormData padded">Save</button> or <a href="#" data-dismiss="modal">Cancel</a>
        </div> 
    </form>        
</div>
