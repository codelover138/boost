<?php
	...
	$next_ref = $request['piggyback']['credit_notes/next_reference'];
...
?>
 <!-- content area -->
   <form method="post" action="<?php echo base_api_url('credit_notes/'); ?>"  autocomplete="off">
   <input type="hidden" name="invoice_id" value="<?php echo (@$document_data['id'] ? $document_data['id']:'0'); ?>" />
         ...
         <?php 
		  ...
		  ?>
           <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
            ...
            <div class="col-sm-9 pull-right-sm no-gutter-xs">
           		<input type="text" class="form-control" id="credit_note_number" name="credit_note_number" value="CN-<?php echo $next_ref; ?>">	              
            </div>
          </div> 
          ...
          <div class="form-group col-xs-12 col-sm-6 pull-left-sm clear-left-sm">
            ...
            <div class="col-sm-9  pull-right-sm no-gutter-xs">
                <input value="<?php if(isset($document_data['discount_percentage'])){echo $document_data['discount_percentage'];}else{ echo '0';} ?>" name="discount_percentage" class="form-control" id="discount_percentage" placeholder="%">
            </div>
          </div>
          ...
          <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
            ...
            <div class="col-sm-9  pull-right-sm  no-gutter-xs">
                <input type="text" class="form-control" name="reference" id="reference" placeholder="Reference" value="<?php echo @$document_data['invoice_number']; ?>">
            </div>
          </div> 
     ...
     <div class="form_section ">
         <div class="container-fluid itemList">
			...
			if(isset($document_data['items'])){
				...
				$this->load->view('global_snippets/item_row'); 
			}
			?>
     ...
     <div class="form_section">
         <div class="form-group col-xs-12 col-sm-6   pull-left-sm clear-left-sm">
              <div class="form-group col-xs-12  no-gutter-xs">
               ...
               <textarea rows="6" class="form-control" name="terms" placeholder="Terms (or Banking Details)"><?php echo $template_data['credit_note_terms']; ?></textarea>                        
              </div>
         </div>
         <div class="form-group col-xs-12 col-sm-6 pull-right-sm clear-right-sm">
               <div class="form-group col-xs-12 no-gutter-xs">
               <label for="closing_note" class="control-label">Closing Note:</label>                       
               <textarea rows="6" class="form-control" name="closing_note" placeholder="Add notes visible to client"><?php echo $template_data['credit_note_closing_note']; ?></textarea>                        
              </div>
         </div>
     </div>
