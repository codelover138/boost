...
<div class="modal-dialog" role="document">
    <form action="<?php echo base_api_url('bulk/contacts/content_status/archived'); ?>" method="put">
        <div class="modal-content">
            ...
            <div class="modal-body">
            	<div class="col-sm-12 form-group">
                	<strong>Are you sure you want to archive the following contacts?</strong>
                </div>
