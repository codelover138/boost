...
?>
 <!-- content area -->
   <form method="put" action="<?php echo base_api_url('contacts/'.$contact_data['id']); ?>"  autocomplete="off">
        <div class="container-fluid bg-white doc-spaced">
                ...
                <div class="container-fluid">
                  ...
                  <div class="form-group col-xs-12 col-sm-6">
                    ...
                    <div class="col-sm-9 pull-right-sm no-gutter-xs">
                         <input type="text" class="form-control" name="organisation" id="organisation" placeholder="Company Name"  value="<?php echo $contact_data['organisation']; ?>" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
                    ...
                    <div class="col-sm-9  pull-right-sm no-gutter-xs">
                        <input type="text" class="form-control" name="vat_number" id="vat_number" placeholder="Vat Number" value="<?php echo $contact_data['vat_number']; ?>">
                    </div>
                  </div>  
                        ...
                        <select id="industry_id" name="industry_id" class="selectpicker full-width">
                         <?php
                            foreach($request['piggyback']['industries'] as $industry_data){
                                if($industry_data['id'] == $contact_data['industry_id']){
                    ...
                    <div class="col-sm-9  pull-right-sm no-gutter-xs">
                         ...
                         <?php
                            foreach($request['piggyback']['company_sizes'] as $company_sizes_data){
                                if($industry_data['id'] == $contact_data['industry_id']){
                                    echo '<option selected="selected" value="'.$company_sizes_data['id'].'">'.$company_sizes_data['size'].'</option>';
                                }else{
             ...
             <div class="form_section">
                ...
                <div class="form-group col-xs-12 col-sm-6">
                    ...
                    <div class="col-sm-9 pull-right-sm no-gutter-xs">
                         <input type="text" class="form-control" name="first_name" id="first_name" placeholder="First Name" value="<?php echo $contact_data['first_name']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
                    ...
                    <div class="col-sm-9  pull-right-sm no-gutter-xs">
                        <input type="text" class="form-control" name="last_name" id="last_name" placeholder="Last Name" value="<?php echo $contact_data['last_name']; ?>">
                    </div>
                </div>  
                ...
                <div class="form-group col-xs-12 col-sm-6">
                    ...
                    <div class="col-sm-9 pull-right-sm no-gutter-xs">
                         <input type="email" class="form-control" name="email" id="email" placeholder="Email Address" value="<?php echo $contact_data['email']; ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
                    ...
                    <div class="col-sm-9  pull-right-sm no-gutter-xs">
                        <input type="text" class="form-control" name="land_line" id="land_line" placeholder="Last Name" value="<?php echo $contact_data['land_line']; ?>">
                    </div>
                </div>
                 ...
                 <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
                    ...
                    <div class="col-sm-9  pull-right-sm no-gutter-xs">
                         <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Mobile" value="<?php echo $contact_data['mobile']; ?>">
                    </div>
                </div>
             ...
             <div class="form_section">
                ...
                <div class="form-group col-xs-12 col-sm-6   pull-left-sm clear-left-sm">
                      <div class="form-group col-xs-12 no-gutter-xs">
                          ...
                          <div class="col-sm-9 pull-right-sm no-gutter-xs">                     
                             <textarea rows="6" name="address" id="address" class="form-control" placeholder="Business Address"><?php echo $contact_data['address']; ?></textarea> 
                          </div>                       
                      </div>
                 </div>      
             </div>
