 ...
 <!-- content area -->
   ...
   <input type="hidden" name="status" value="draft" />
    <div class="container-fluid bg-white doc-spaced">
      ...
      <div class="form_section">
          <div class="form-group col-xs-12 col-sm-6">
            ...
            <div class="col-sm-9 pull-right-sm no-gutter-xs">
                <?php 
					...
					$contact_data['current_id'] = @$contact_data['contact']['id'];
                ...
                <select id="currency_id" name="currency_id" class="selectpicker full-width">
                	<?php						
						foreach($request['piggyback']['currencies'] as $currency_data){
							if($contact_data['currency_id'] ==  $currency_data['id']){
          ...
          <div class="form-group col-xs-12 col-sm-6 pull-left-sm clear-left-sm">
            ...
            <div class="col-sm-9  pull-right-sm no-gutter-xs">
                <input value="<?php echo $contact_data['discount_percentage']; ?>" name="discount_percentage" class="form-control" id="discount_percentage" placeholder="%">
            </div>
          </div>
          
          <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
            <label for="contact_number" class="control-label pull-left-sm">Contact No</label>
            <div class="col-sm-9 pull-right-sm no-gutter-xs">
                <input type="text" class="form-control" name="contact_number" id="contact_number" value="INV-<?php echo $request['piggyback']['contacts/next_reference']; ?>">
            </div>
          </div> 
          ...
          <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
            ...
            <div class="col-sm-9  pull-right-sm  no-gutter-xs">
                <input type="text" class="form-control" name="reference" id="reference" placeholder="Reference" value="<?php echo $contact_data['reference']; ?>">
            </div>
          </div> 
          
           <div class="form-group col-xs-12 col-sm-6 pull-left-sm clear-left-sm">
             <div class="col-sm-9  pull-right-sm no-gutter-xs">
             	<input type="hidden" id="reminder" name="reminder" value="<?php echo $contact_data['reminder']; ?>" />
                <a id="reminder_cta" href="<?php echo base_url('contacts/modal/reminder/'); ?><?php echo $contact_data['reminder']; ?>/<?php echo $contact_data['id']; ?>" class="open-modal">
                	<?php
						if($contact_data['reminder'] == '0'){
							...
							echo 'Reminder sent every '.$contact_data['reminder'].' Days';
						}
                 	?>  
                </a>
             </div>
     ...
     <div class="form_section ">
         <div class="container-fluid itemList">
            ...
            <?php 
				foreach($contact_data['items'] as $item_data['data']){
     ...
     <div class="form_section">
         <div class="form-group col-xs-12 col-sm-6   pull-left-sm clear-left-sm">
              <div class="form-group col-xs-12  no-gutter-xs">
               ...
               <textarea rows="6" class="form-control" name="terms" placeholder="Terms (or Banking Details)"><?php echo $contact_data['terms']; ?></textarea>                        
              </div>
         </div>
         <div class="form-group col-xs-12 col-sm-6 pull-right-sm clear-right-sm">
               <div class="form-group col-xs-12 no-gutter-xs">
               <label for="closing_note" class="control-label">Closing Note:</label>                       
               <textarea rows="6" class="form-control" name="closing_note" placeholder="Add notes visible to client"><?php echo $contact_data['closing_note']; ?></textarea>                        
              </div>
         </div>
     </div>
    ...
    <div class="form_section container-fluid" style="text-align:right;">
         <button data-redirect-url="<?php echo base_url('contacts'); ?>" data-modal-url="<?php echo base_url('modal/notice'); ?>" data-close-delay-seconds="1" data-modal-heading="Success" data-modal-body="Saved Successfully. " type="button" class="btn btn-default saveButton padded saveFormData">Save</button>
         <button data-redirect-url="<?php echo base_url('contacts'); ?>" data-modal-url="<?php echo base_url('contacts/modal/send'); ?>" type="button" class="btn btn-success saveButton saveFormData">Send</button>
    </div>
