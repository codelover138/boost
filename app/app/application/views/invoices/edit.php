...
?>
 <!-- content area -->
   <form method="put" action="<?php echo base_api_url('invoices/'.$invoice_data['id']); ?>"  autocomplete="off">
      ...
      <div class="form_section">
          ...
          <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
            ...
            <div class="col-sm-9 pull-right-sm no-gutter-xs">
			   ...
			   ?>
                		<input disabled="disabled" type="text" class="form-control" id="invoice_number" value="<?php echo $invoice_data['invoice_number']; ?>">	
               <?php
					}else{
			   ?>
               			<input type="text" class="form-control" name="invoice_number" id="invoice_number" value="<?php echo $invoice_data['invoice_number']; ?>">	
               <?php
					}
			   ?>
            </div>
          ...
          <div class="form-group col-xs-12 col-sm-6  pull-right-sm clear-right-sm">
           ...
           <div class="form-group col-xs-12 col-sm-6 pull-left-sm clear-left-sm">
             <div class="col-sm-9  pull-right-sm no-gutter-xs">
                ...
                <a id="reminder_cta" href="<?php echo base_url('invoices/modal/reminder/'.$invoice_data['reminder'].'/'.$invoice_data['id']); ?>" class="open-modal">
                	<?php
