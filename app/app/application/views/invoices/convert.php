<?php
	...
	if(empty($invoice_data['reminder']))
		$invoice_data['reminder'] = 0;
	
?>
 <!-- content area -->
   <form method="post" data-success-function="markEstInvoiced(<?php echo $invoice_data['id']; ?>)" action="<?php echo base_api_url('invoices/'); ?>"  autocomplete="off">
