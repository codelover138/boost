...
?>
    ...
    <div class="container-fluid bg-white doc-spaced">
        <div class="col-xs-12">
            ...
            <button data-redirect-url="<?php echo base_url('settings/users'); ?>"
                class="btn btn-default pull-right-xs open-modal"
                href="<?php echo base_url('settings/modal/users/add'); ?>" type="button">Add New User &nbsp; &nbsp;
                +</button>
        </div>
...
?>
                <tr>
                    ...
                    <td><?php echo ucwords($user_data['first_name'] . ' ' . $user_data['last_name']); ?>
                        <div class="listHoverOptions hidden-xs"><a class="open-modal"
                                href="<?php echo base_url('settings/modal/users/edit/' . $user_data['id']); ?>">Edit</a>|<a
                                class="open-modal"
                                href="<?php echo base_url('settings/modal/users/delete/' . $user_data['id']); ?>">Trash</a>
                        </div>
                        <div class="visible-xs-block list-small-top-margin"><a class="greyLink smallGreyLightened"
...
?>
                    ...
                    <td class="hidden-xs">
                        <div><a class="greyLink"
                                href="mailto:<?php echo $user_data['email']; ?>"><?php echo $user_data['email']; ?></a>
                        </div>
                        <div class="smallGreyLightened list-small-top-margin">
                            <?php echo $user_data['contact_number']; ?></div>
                    </td>

                    <td>
                        <div style="position:relative;" class="nav nav-pills pull-right">
                            <button role="button" aria-haspopup="true" data-toggle="dropdown" type="button"
                                class="btn btn-info btn-xs"> <span class="caret"></span> </button>
                            <ul class="dropdown-menu">
                                <li><a class="open-modal"
                                        href="<?php echo base_url('settings/modal/users/edit/' . $user_data['id']); ?>">Edit</a>
                                </li>
                                <li><a class="open-modal"
                                        href="<?php echo base_url('settings/modal/users/delete/' . $user_data['id']); ?>">Trash</a>
                                </li>
...
?>
        ...
        <div class="form_section container-fluid" style="text-align:right;">
            <a href="<?php echo base_url('settings/roles'); ?>" type="button"
                class="btn btn-success saveButton">Continue</a>
        </div>
