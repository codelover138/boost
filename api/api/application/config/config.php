...
$config['domain'] = 'boostaccounting.com';
$config['document_url'] = $config['domain'].'/documents/';
...
|
 */
$config['api_url'] = 'https://api.boostaccounting.com/api/';
//$config['api_url'] = 'http://api.boostaccounting.com/api/';
...
|
 */
$config['db_account_prefix'] = 'boost_';
...
|
 */
$config['db_table_prefix'] = 'boost_';

/*
|--------------------------------------------------------------------------
| VALID PASSWORD LENGTH (MIN & MAX)
|--------------------------------------------------------------------------
|
 */
$config['pass_min_length'] = 6;
$config['pass_max_length'] = 20;
...
/*
|--------------------------------------------------------------------------
| DISALLOWED ACCOUNT NAMES
|--------------------------------------------------------------------------
|
| Any item in this array will not be allowed as a company name when signing up
| each string is case insensitive and whitespace is ignored
 */
$config['disallowed_account_names'] = array(
	'www',
	'app',
	'api',
	'blog',
...
|
*/
$config['encryption_key'] = 'SOI@active001';
...
$config['sess_cookie_name'] = 'boost_session';
$config['sess_table_name']		= 'boost_sessions';
