...
class Api extends CI_Controller
{
    public function __construct()
    {
        ...
        $dont_check_subscription = array_merge($dont_validate_token, array('subscription', 'me'));
            ...
            if ($account_name) {
                ...
                if ($org) {
                    ...
                    if ($paid_until_ts && !$grace_until_ts) {
                        ...
                        $grace_until_ts = strtotime('+' . $this->payment_settings->get_grace_period_days() . ' days', $paid_until_ts);
                    }
                    ...
                    if ($is_blocked) {
                        ...
                        $this->regular->respond(array(
                            ...
                            'message' => array('Your subscription has been cancelled or expired. Please renew to continue using Boost Accounting.')
                        ));
                        exit;
                    }
                }
